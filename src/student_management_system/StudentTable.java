...
public final class StudentTable extends JFrame implements ActionListener {
    ...
    private String [] columns ={"First Name","Last Name","Phone","GPA"};
   ...
   public void initComponents(){
        ...
        titleLabel= new JLabel ("Sudent registration Form");
   ...
   @Override
    public void actionPerformed(ActionEvent e) {
        ...
        model.removeRow(numberofRow);
            ...
            JOptionPane.showMessageDialog(null,"No row has been selected / No row exist");
            }
        }
